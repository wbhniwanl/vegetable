    ...
    <div class="row">
		<div class="span9">
			<div class="">
				...
				<?php if(is_array($techer_list1)): $i = 0; $__LIST__ = $techer_list1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!--
                  ...
                  -->
                    <div class="two">
                    	<a></a>
					<h2><a href="<?php echo U('blog/index/job_output',array('id'=>$vo['position_id']));?>"><?php echo ($vo["teacher_name"]); ?></a></h2>
					<p style="font-size:16px;"><?php echo ($vo["Te_job"]); ?></p>
					</div>	
					<div>
						<div class="pull-left">
