	...
	<div class="row">
		<div  style="border: 1px solid ;margin: 0 auto;width: 900px">
			...
			<div class="tc-box first-box article-box">
				...
				<?php if(is_array($techer_detil)): $i = 0; $__LIST__ = $techer_detil;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div style="overflow: auto">
					<div style="float: left; margin-left: 100px;margin:auto; font-size: large">

						<!-- <pre>用 户 名：<?php echo ($vo["user_id"]); ?></br></pre> -->
						导师姓名：<?php echo ($vo["teacher_name"]); ?></br></br>
						联系电话：<a style="color: #FF0000"><?php echo ($vo["content_way"]); ?></a></br></br>
						联系地址：<?php echo ($vo["address"]); ?></br></br>
						邮箱：<?php echo ($vo["email"]); ?></br></br>
						辅导状态：<?php echo ($vo["te_state"]); ?></br></br>
						最大辅导人数：<?php echo ($vo["max_number"]); ?></br></br>
						性别：<?php echo ($vo["sex"]); ?></br></br>
