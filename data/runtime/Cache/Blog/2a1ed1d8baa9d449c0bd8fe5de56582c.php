    ...
    <div class="row">
		<div class="span9">
			<div class="">
				...
				<?php if(is_array($Job_offer_list)): $i = 0; $__LIST__ = $Job_offer_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list-boxes">
					<h2><a href="<?php echo U('blog/index/job_output',array('id'=>$vo['position_id']));?>"><?php echo ($vo["position_title"]); ?></a></h2>
					<p style="font-size:16px;"><?php echo ($vo["position_describe"]); ?></p>
					<div>
						<div class="pull-left">
