    ...
    <div class="row">
		<div class="span9">
			<div class="">
				...
				<?php if(is_array($act1)): $i = 0; $__LIST__ = $act1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voa): $mod = ($i % 2 );++$i;?><div class="list-boxes">
					<h1><a href="<?php echo U('blog/index/job_output',array('id'=>$voa['position_id']));?>"><?php echo ($voa["position_title"]); ?></a></h1>
					<h2><p><?php echo ($voa["job_offer"]); ?></p></h2>
					<div>
						<div class="pull-left">
					...
					<?php if(is_array($act2)): $i = 0; $__LIST__ = $act2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vob): $mod = ($i % 2 );++$i;?><div class="list-boxes">
					<h1><a href="<?php echo U('blog/index/job_output',array('id'=>$vob['position_id']));?>"><?php echo ($vob["position_title"]); ?></a></h1>
					<h2><p><?php echo ($vob["job_offer"]); ?></p></h2>
					<div>
						<div class="pull-left">
							<div class="list-actions">
					...
					<?php if(is_array($act3)): $i = 0; $__LIST__ = $act3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voc): $mod = ($i % 2 );++$i;?><div class="list-boxes">
					<h1><a href="<?php echo U('blog/index/job_output',array('id'=>$voc['position_id']));?>"><?php echo ($voc["position_title"]); ?></a></h1>
					<h2><p><?php echo ($voc["job_offer"]); ?></p></h2>
					<div>
						<div class="pull-left">
							<div class="list-actions">
