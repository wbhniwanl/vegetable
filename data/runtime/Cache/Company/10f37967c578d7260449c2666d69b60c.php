...
<div class="navbar navbar-fixed-top">
 ...
 $effected_id="main-menu"; $filetpl="<a href='\$href' target='\$target'>\$label</a>"; $foldertpl="<a href='\$href' target='\$target' class='dropdown-toggle' data-toggle='dropdown'>\$label <b class='caret'></b></a>"; $ul_class="dropdown-menu" ; $li_class="" ; $style="nav"; $showlevel=6; $dropdown='dropdown'; echo sp_get_menu("main",$effected_id,$filetpl,$foldertpl,$ul_class,$li_class,$style,$showlevel,$dropdown); ?>
	...
	<a class="list-group-item" href="<?php echo U('Company/profile/edit');?>"><i class="fa fa-list-alt fa-fw"></i> 修改资料</a>
	<a class="list-group-item" href="<?php echo U('Company/profile/fusta');?>"><i class="fa fa-star-o fa-fw"></i> 查看辅导</a>
	<a class="list-group-item" href="<?php echo U('Company/profile/93');?>"><i class="fa fa-list-alt fa-fw"></i> 查看创新项目</a>
	<a class="list-group-item" href="<?php echo U('Company/profile/password');?>"><i class="fa fa-lock fa-fw"></i> 修改密码</a>
	<a class="list-group-item" href="<?php echo U('Company/profile/avatar');?>"><i class="fa fa-user fa-fw"></i> 编辑头像</a>
