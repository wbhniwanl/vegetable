			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<?php if(is_array($Position_info)): foreach($Position_info as $key=>$vo): ?><tr>
						...
						<td align="center">
							<a href="<?php echo U('blog/index/checkcompany',array('id'=>$vo['id']));?>" ><?php echo L('BLOCK_USER');?></a>|
