			...
			<div class="span4 offset4">
				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="email">
						<form class="form-horizontal js-ajax-form" action="<?php echo U('company/register/doregister');?>" method="post">
		
							<div class="control-group">
								<input type="text" name="username" placeholder="用户名" class="span4">
							</div>
                            <div class="control-group">
								<input type="text" name="teacher_name" placeholder="真实姓名" class="span4">
							</div>
                            
                            <div class="control-group">
								<input type="text" name="Company_way" placeholder="联系电话" class="span4">
							</div>
							  <div class="control-group">
								<input type="text" name="email" placeholder="常用邮箱" class="span4">
							</div>
							...
							<div class="control-group" style="text-align: center;">
								<p>
									已有账号? <a href="<?php echo leuu('company/login/index');?>">点击此处登录</a>
								</p>
							</div>
						</form>
