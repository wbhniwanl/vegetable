	...
	<div class="container tc-main">
		<div class="row">
			<div class="span4 offset4">
				<h2 class="text-center">导师登录</h2>
				<form class="form-horizontal js-ajax-forms" action="<?php echo U('company/login/dologin');?>" method="post">
					<div class="control-group">
						<input type="text" id="input_username" name="company_name" placeholder="用户名" class="span4">
					</div>
					...
					<div class="control-group" style="text-align: center;">
						<ul class="inline">
							<li><a href="http://127.0.0.1/index.php?g=company&m=Register&a=index">现在注册</a></li>
