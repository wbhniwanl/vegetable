				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="email">
						<form class="form-horizontal js-ajax-form" action="<?php echo U('user/register/doregister');?>" method="post">
							...
							<div class="control-group">
								<input type="text" name="student_id" placeholder="学号" class="span4">
							</div>
							<div class="control-group">
								<input type="text" name="email" placeholder="邮件" class="span4">
							</div>
							<div class="control-group">
								<input type="text" name="connect_way" placeholder="联系电话" class="span4">
							</div>
							...
							<div class="control-group">
								<input type="text" name="key_word1" placeholder="关键字1" class="span4">
							</div>
							<div class="control-group">
								<input type="text" name="key_word2" placeholder="关键字2" class="span4">
							</div>
							<div class="control-group">
								<input type="text" name="key_word3" placeholder="关键字3" class="span4">
							</div>
