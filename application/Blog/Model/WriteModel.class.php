...
if($company_name==null&&$company_address==null&&$content_way==null){//存入注册的用户信息 巧妙的利用了if判断语句，简洁的完成了参数不同的方法的重载,
	 ...
	 public function write_offer($Position_title,$Position_name,$Position_nature,$Work_place,$Sex_require,$Require_number,$Job_offer,$Work_time,$Position_describe,$Contact,$Contact_way){
	 //招聘信息导入数据库的模板
	   $User = M('recruit_list');
